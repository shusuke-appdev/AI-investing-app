        ...
        rx.vstack(
            ...
            rx.grid(
                rx.vstack(
                    ...
                    rx.text(opt.pcr_vol_str, weight="bold", color=rx.color(pcr_color, 9)),
                    align_items="start",
                    spacing="1"
                ),
                rx.vstack(
                    rx.text("Net GEX", size="1", color="gray"),
                    rx.text(opt.net_gex_str, weight="bold", color=rx.color(gex_color, 9)),
                    align_items="start",
                    spacing="1"
                ),
                rx.vstack(
            ...
            rx.cond(
                ...
                rx.vstack(
                    rx.foreach(opt.analysis, lambda item: rx.text("• ", item, size="1", color="gray")),
                    align_items="start",
                    spacing="1"
                ),
