...
JP_THEMES: dict[str, list[str]] = {
    # 半導体・エレクトロニクス
    "半導体製造装置": ["8035.T", "6857.T", "6920.T", "7735.T", "6146.T"],  # 東京エレク、アドバンテスト、レーザーテック、SCREENホールディングス、ディスコ
    "半導体部材": ["4063.T", "4004.T", "6988.T", "6981.T"],  # 信越化学、レゾナック、日東電工、村田製作所
    "電子部品": ["6981.T", "6762.T", "6594.T", "6976.T", "6770.T"],  # 村田製作所、TDK、日本電産、太陽誘電、アルプスアルパイン
    
    # 自動車・輸送
    "自動車大手": ["7203.T", "7201.T", "7267.T", "7261.T", "7270.T"],  # トヨタ、日産、本田、マツダ、SUBARU
    "自動車部品": ["7259.T", "6902.T", "5108.T", "7282.T"],  # アイシン、デンソー、ブリヂストン、豊田合成
    "EV/電池": ["6752.T", "6645.T", "7203.T", "6674.T"],  # パナソニック、オムロン、トヨタ、GSユアサ
    
    # 機械・産業
    "産業機械": ["6301.T", "6326.T", "6305.T", "6273.T"],  # 小松製作所、クボタ、日立建機、SMC
    "FA・ロボティクス": ["6954.T", "6861.T", "6506.T", "6273.T"],  # ファナック、キーエンス、安川電機、SMC
    "建設機械": ["6301.T", "6305.T", "7011.T"],  # 小松製作所、日立建機、三菱重工
    
    # 金融
    "メガバンク": ["8306.T", "8316.T", "8411.T"],  # 三菱UFJ、三井住友FG、みずほFG
    "保険": ["8630.T", "8766.T", "8725.T", "8750.T"],  # SOMPO、東京海上、MS&AD、第一生命
    "証券": ["8604.T", "8601.T", "8628.T"],  # 野村HD、大和証券、松井証券
    "リース": ["8593.T", "8566.T", "8439.T"],  # 三菱HCキャピタル、リコーリース、東京センチュリー
    
    # 素材・化学
    "総合化学": ["4188.T", "4005.T", "4183.T", "4631.T"],  # 三菱ケミカル、住友化学、三井化学、DIC
    "鉄鋼": ["5401.T", "5411.T", "5406.T"],  # 日本製鉄、JFE、神戸製鋼
    "非鉄金属": ["5706.T", "5713.T", "5714.T", "5802.T"],  # 三井金属、住友金属鉱山、DOWAホールディングス、住友電工
    
    # 消費・小売
    "小売": ["9983.T", "3382.T", "8267.T", "7453.T"],  # ファストリ、セブン&アイ、イオン、良品計画
    "EC/デジタルコマース": ["4755.T", "4689.T", "3092.T"],  # 楽天グループ、ヤフー(LINEヤフー)、ZOZO
    "外食": ["2702.T", "3197.T", "7550.T"],  # マクドナルド、すかいらーく、ゼンショー
    
    # ヘルスケア・医薬
    "医薬品大手": ["4502.T", "4503.T", "4519.T", "4523.T", "4568.T"],  # 武田、アステラス、中外製薬、エーザイ、第一三共
    ...
    # IT・ソフトウェア
    "SIer/ITサービス": ["9719.T", "4307.T", "2127.T", "3774.T"],  # SCSK、野村総研、日本M&Aセンター、IIJ
    "ゲーム": ["9684.T", "9766.T", "3659.T", "7974.T", "9697.T"],  # スクエニ、コナミ、ネクソン、任天堂、カプコン
    "ソフトウェア開発": ["4686.T", "4768.T", "3962.T"],  # ジャストシステム、大塚商会、チェンジ
    
    # 不動産
    "不動産大手": ["8801.T", "8802.T", "8830.T"],  # 三井不動産、三菱地所、住友不動産
    "J-REIT": ["8951.T", "8952.T", "8960.T"],  # 日本ビルファンド、ジャパンリアルエステイト、ユナイテッド・アーバン
    
    # その他
    "商社": ["8058.T", "8001.T", "8053.T", "8031.T", "8002.T"],  # 三菱商事、伊藤忠、住友商事、三井物産、丸紅
