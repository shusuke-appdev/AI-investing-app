...
from src.news_analyst import generate_market_recap  # noqa: E402
...
def test_prompt_generation():
    ...
    news_data = [
        {
            "title": "Fed kept rates unchanged",
            "source": "GNews",
            "category": "BUSINESS",
    ...
    try:
        ...
        with patch("src.news_analyst.genai.GenerativeModel") as mock_model:
            ...
            generate_market_recap(market_data, news_data, option_analysis)
