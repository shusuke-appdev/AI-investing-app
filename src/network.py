...
@st.cache_resource
def get_session(cache_name: str = "app_cache", expire_after: int = CACHE_EXPIRE_SECONDS) -> requests.Session:
    """
...
def safe_request(url: str, params: dict = None, timeout: int = DEFAULT_TIMEOUT) -> requests.Response:
    """
